...
public class Level1AState extends GameState {
	...
	public void init() {
		...
		// backgrounds
		sky = new Background("/Backgrounds/sky3.png", 0);
		...
		// title and subtitle
		try {
			hageonText = ImageIO.read(getClass().getResourceAsStream("/HUD/Test.png"));
	...
	private void eventDead() {
		...
		if(eventCount >= 120) {
			if(player.getLives() == 0) {
                  ...
                  UI.put ("OptionPane.background", Color.TRANSLUCENT);
                  UI.put ("Panel.background" , Color.BLACK);
                  UI.put ("Button.background",Color.BLACK);
                  
                  UI.put ("Button.foreground", new Font ("Century Gothic" ,Font.BOLD,12));
                  UI.put ("Button.foreground",Color.WHITE);
                        
           JOptionPane.showMessageDialog(null,"Game Over","Goodbye!", JOptionPane.INFORMATION_MESSAGE);
           System.exit(0);
